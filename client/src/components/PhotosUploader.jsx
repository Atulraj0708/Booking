  ...
  return (
    <>
      <div className="flex gap-2">
                <input type="text" value={photoLink} onChange={(e)=>{setPhotoLink(e.target.value)}}  placeholder={"Add using a Link...jpg/jpeg"} />
              ...
              <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                {photos.length>0 && photos.map(link => (
                  <div className="h-32 flex relative" key={link}>
                     <img className="rounded-2xl w-full object-cover" src={process.env.REACT_APP_SER_URL+"/uploads/"+link} alt="Loading.." />   
